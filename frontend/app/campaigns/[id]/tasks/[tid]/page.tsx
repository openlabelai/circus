  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        <button onClick={() => router.push(`/campaigns/${id}/tasks`)} className="text-gray-400 hover:text-white text-sm">
          &larr; Back
        </button>
        <h2 className="text-2xl font-bold">{task.name}</h2>
        <div className="ml-auto flex gap-2">
          <Link
            href={`/campaigns/${id}/tasks/${tid}/edit`}
          ...
          <button
            onClick={async () => {
              ...
              router.push(`/campaigns/${id}/tasks`);
            }}
