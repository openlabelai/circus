...
import { getProject, getArtistProfile, runArtistResearch } from "@/lib/api";
...
export default function ProjectResearchPage() {
  ...
  useEffect(() => {
    ...
    getProject(id)
      .then((project) => {
        if (project.artist_profile) {
          return getArtistProfile(project.artist_profile).then((p) => {
            setProfile(p);
            setNoProfile(false);
          });
        } else {
      ...
      <div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 text-center">
          <p className="text-gray-400 mb-4">
            No artist profile linked to this project. Link one in the project settings, or create a new profile first.
          </p>
