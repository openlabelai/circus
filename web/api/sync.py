...
def export_persona_to_yaml(db_persona) -> str:
    ...
    cp = CircusPersona(
        ...
        genre=db_persona.genre,
        archetype=db_persona.archetype,
        favorite_artists=db_persona.favorite_artists,
        music_discovery_style=db_persona.music_discovery_style,
        comment_style=db_persona.comment_style,
        bio_template=db_persona.bio_template,
        username_style=db_persona.username_style,
        engagement_pattern=db_persona.engagement_pattern,
        content_behavior=db_persona.content_behavior,
        profile_aesthetic=db_persona.profile_aesthetic,
        artist_knowledge_depth=db_persona.artist_knowledge_depth,
        behavior=BP(
